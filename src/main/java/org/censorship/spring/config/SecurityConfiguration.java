...
import org.censorship.spring.security.CustomRequestCache;
import org.censorship.spring.utils.SecurityUtils;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
   ...
   public User currentUser(UserRepository userRepository){
       ...
       User user = username!=null?userRepository.findByEmailAddress(username):null;
       return user;
   }
